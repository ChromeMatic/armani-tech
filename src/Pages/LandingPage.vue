    ...
    <div class="dark:text-white dark:bg-gray-900 bg-gray-50">
      ...
      <div class="flex lg:py-32 lg:px-10 py-14 p-6 lg:flex-row 
        ...
        <div class="flex flex-col space-y-4 text-center">
          ...
          <a href="./Armani_Resume_1.pdf" class="flex justify-center px-8 rounded py-2 uppercase font-semibold bg-green-400 dark:bg-indigo-500 hover:dark:bg-indigo-400 hover:bg-green-500 transition duration-75" target="_blank" rel="noopener noreferrer">
